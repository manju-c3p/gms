	...
	<form method="post" action="<?= base_url('index.php/Quotation/update'); ?>" class="p-6 bg-white">
		...
		<div class="page-header flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
			...
			<div class="flex flex-col sm:flex-row sm:flex-wrap gap-2 justify-center lg:justify-end">
				...
				<button type="submit"
					id="updateBtn"
					class="hidden w-full sm:w-auto px-6 py-2 bg-blue-700 text-white rounded">
					Update
				</button>
				...
				<a href="<?= base_url('index.php/Quotation/view/' . $quotation->quotation_id) ?>"
				...
				<a href="<?= base_url('index.php/Jobcard/edit_by_quotation/' . $quotation->quotation_id) ?>"
					class="w-full sm:w-auto text-center px-6 py-2 bg-green-400 text-white rounded">
					Job Card
				</a>
				...
				<table class="w-full border text-sm min-w-[500px]">
					...
					<tbody>
						...
						<tr>
							...
							<td class="border p-2">
								<input type="email" class="w-full border rounded px-2 py-1 bg-gray-100"
						...
						<!-- ROW 4 -->
						<tr>
							<td class="border p-2 font-medium">Quotation No</td>
							<td class="border p-2">
								<input type="text" class="w-full border rounded px-2 py-1 bg-gray-100" value="<?= $quotation->quotation_no ?>" readonly>
							</td>

							<td class="border p-2 font-medium">KM In</td>
							<td class="border p-2">
								<input type="number" name="kmin" class="w-full border rounded px-2 py-1 bg-gray-100" value="<?= $kms ?>" readonly>
							</td>
							<td class="border p-2 font-medium">Quotation Status</td>
							<td class="border p-2">
						...
						<tr>
							...
							<td class="border p-2">
								<input type="number"
									...
									name="estimatedprice"
									value="<?= $estimation->customer_estimated_price ?? '' ?>" readonly>
							</td>

							<td class="border p-2 font-medium">Estimated Delivery Date</td>
							<td class="border p-2">
								<input type="date" class="w-full border rounded px-2 py-1 bg-gray-100" name="estdeldate" value="<?= $estimation->est_delivery_date ?? '' ?>" readonly>
							</td>

							<td class="border p-2 font-medium">Completion Time</td>
							<td class="border p-2">
								<input type="time" class="w-full border rounded px-2 py-1 bg-gray-100" name="completiontime" value="<?= $estimation->est_completion_time ?? '' ?>" readonly>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="border p-2" colspan="5">
								<textarea class="w-full border rounded px-2 py-1 h-20 bg-gray-100" name="remarks"><?= $estimation->remarks ?? '' ?></textarea>
							</td>
						</tr>
		...
		<div class="flex items-center justify-between mb-4">
			...
			<button type="button" id="addService"
				class="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition hidden">
			...
			<table class="w-full border-collapse text-sm" id="serviceTable">
				...
				<thead>
					<tr class="bg-gray-100 text-gray-700">
						...
						<th class="border px-3 py-2 w-20 text-center hidden">Action</th>
					</tr>
				</thead>
		...
		<p class="text-xs text-gray-500 mt-3">
			Service is calculated automatically based on time and rate.
		</p>
		<hr class="border-gray-300 mb-6">
				...
				<table class="w-full border-collapse text-sm" id="newPartsTable">
					<thead class="bg-blue-50">
						<tr>
							...
							<th class="border px-3 py-2 text-center w-20 hidden">Action</th>
							<!-- <th></th> -->
						</tr>
					</thead>
					<tbody>
								...
								<tr class="hover:bg-gray-50 transition">
									...
									<td class="border px-2 py-2 hidden">
										<select name="brand_id[]"
											class="editable brandSelect w-full border rounded-lg px-2 py-1">
					...
					<tfoot>
						<!-- Parts Sub Total -->
						<tr class="bg-gray-100 font-semibold">
							<td colspan="9" class="text-right px-3 py-2">Parts Sub Total</td>
							<td class="px-3 py-2 text-right">
								<input type="text"
									id="parts_subtotal"
									class="w-full text-right bg-gray-100"
						...
						<!-- Total Discount -->
						<tr class="bg-gray-50">
							<td colspan="9" class="text-right px-3 py-2">Total Discount</td>
							<td class="px-3 py-2 text-right">
								<input type="text"
						...
						<!-- Taxable Amount -->
						<tr class="bg-gray-100 font-semibold">
							<td colspan="9" class="text-right px-3 py-2">Taxable Amount</td>
							<td class="px-3 py-2 text-right">
								<input type="text"
									id="parts_taxable"
									class="w-full text-right bg-gray-100"
						...
						<!-- VAT 5% -->
						<tr class="bg-gray-50">
							<td colspan="9" class="text-right px-3 py-2">VAT (5%)</td>
							<td class="px-3 py-2 text-right">
								<input type="text"
									id="parts_vat"
									class="w-full text-right bg-gray-100"
						...
						<!-- Total Including VAT -->
						<tr class="bg-gray-200 font-semibold">
							<td colspan="9" class="text-right px-3 py-2">Parts Total (Including VAT)</td>
							<td class="px-3 py-2 text-right">
								<input type="text"
		...
		<div class="mb-10">
			...
			<button type="button" id="addAftermarketPart"
				class="mb-3 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 hidden">
		...
		<div>
			...
			<button type="button" id="addUsedPart"
				class="mb-3 px-4 py-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 hidden">
				+ Add Used Part
			</button>
			...
			<table class="w-full border-collapse text-sm" id="jobDescTable">
				...
				<thead>
					<tr class="bg-gray-100 text-gray-700">
						...
						<th class="border px-4 py-2 w-24 text-center hidden">Action</th>
					</tr>
				</thead>
					...
					<?php if (!empty($job_descriptions)): ?>
						<?php foreach ($job_descriptions as $i => $j): ?>
							<tr class="hover:bg-gray-50 transition" id="job_1">
								...
								<!-- Action -->
								<td class="border px-3 py-2 text-center hidden">
									<button type="button"
										class="remove-row inline-flex items-center justify-center 
                                           bg-red-100 text-red-600 
                                           hover:bg-red-500 hover:text-white 
		...
		<div class="bg-white rounded-2xl shadow-md p-6 mt-8 text-sm" style="display:none">
			...
			<div class="grid grid-cols-5 gap-4 items-end">
				...
				<div>
					...
					<input id="totdiscount" name="totdiscount"
...
<script>
	...
	function calculateGrandTotal() {
		...
		const discount = num(document.getElementById("totdiscount")?.value);
