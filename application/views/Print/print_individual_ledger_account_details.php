...
<table class="data-table">
    ...
    $tamount = 0; $opening_bal = 0; $for_loop = 0; $j = 1;
        ...
        foreach ($ledger_transaction_records as $row) {
            ...
            <?php
                ...
                switch ($row->voucher_type) {
                    ...
                    case 'G': echo 'PO GRN Invoice'; break;
                    case 'R': echo 'Receipt'; break;
                    case 'P': echo 'Payment'; break;
                    case 'C': echo 'Credit Note'; break;
                    case 'D': echo 'Debit Note'; break;
                    case 'J': echo 'Journal'; break;
                    case 'N': echo 'Contra Entry'; break;
                }
                echo "</td>";
