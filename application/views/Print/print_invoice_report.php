...
<div id="printable">
 ...
 <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px;">
	...
	<!-- Report Title -->
	<div class="report-title-bar">INVOICE REPORT</div>
	...
	<table>
		...
		<tbody>
		<?php $sum = 0; $i = 1; if (!empty($records)) : ?>
			<?php foreach ($records as $row) : ?>
				<tr>
					<td><?php echo $i++; ?></td>
					<td><?php echo $row->invoice_code; ?><br><?php echo date('d-M-Y', strtotime($row->invoice_date)); ?></td>
					<td><?php echo $row->quotation_code; ?></td>
					<td><?php echo $row->cust_name; ?></td>
					<td><?php echo $row->enq_type; ?></td>
					<td><?php echo $row->inv_type; ?></td>
					<td><?php echo number_format($row->grand_total, 2); $sum += $row->grand_total; ?></td>
				</tr>
			<?php endforeach; ?>
		<?php endif; ?>
		</tbody>
	...
	<div class="summary-row">
		...
		<div><strong>Total: <?php echo number_format($sum, 2); ?></strong></div>
	</div>
	<!-- Meta Info -->
    <div class="meta-info">
