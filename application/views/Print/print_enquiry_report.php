...
<div id="printable">
 ...
 <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px;">
    ...
    <!-- Title -->
    <div class="report-title-bar">ENQUIRY REPORT</div>

    <!-- Date Range -->
    <table>
        <tr>
            <th>Todays Date: <?= date('d-M-Y'); ?></th>
        ...
        <tbody>
            ...
            if (!empty($records)) :
                foreach ($records as $row): ?>
                    <tr>
                        <td><?= $i++; ?></td>
                        <td><?= $row->enquiry_id . '/' . $row->enquiry_code; ?></td>
                        <td><?= date('d-M-Y', strtotime($row->enq_date)); ?></td>
                        <td><?= $row->cust_name; ?></td>
                        <td><?= $row->client_ref; ?></td>
                        <td><?= $row->enq_source; ?></td>
                        <td><?= $row->enq_type; ?></td>
                    </tr>
    ...
    <div class="summary-row">
        <div><strong>Records Total: <?= count($records); ?></strong></div>
    </div>
