	  		...
	  		<div class="col-xs-12 col-sm-9 col-md-3 col-lg-2" role='group'>
				<div class="input-group date datepicker1">			                  
					...
					<div class="input-group-addon"><i class="fa fa-calendar"></i></div>
					  ...
					  <label  class="col-sm-3 control-label col-lg-2">Select Supplier</label>
		      <div class="col-sm-4 col-lg-4">
			<select name="debtor" id="debtor" class="form-control select2" tabindex="2" onchange="get_invoice_list()">
	    ...
	    <div class="form-group row">
			...
			<div class="form-group row">
		     <div class="col-md-6">
                                ...
                                <thead>
                                    <tr>
                               		    <th title="Item">Debit Account (Cr)</th> 
