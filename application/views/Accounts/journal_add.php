...
<div class="bg-white rounded-xl shadow p-6">
	<div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
		<h2 class="text-lg font-semibold text-gray-800">Journal Entry</h2>

		<span class="flex gap-2">
			<a href="<?php echo base_url('index.php/Accounts/journal'); ?>"
			...
			<a href="<?php echo base_url('index.php/Accounts/view_journal_list'); ?>"
				class="inline-flex items-center rounded-full bg-blue-100 text-blue-700 text-xs font-medium px-3 py-1 hover:bg-blue-200 transition"
				title="List Records">
				List Records
			</a>
	...
	<form action="<?php echo base_url() . 'index.php/accounts/add_journal_details'; ?>"
		id="receipt"
		method="post"
		name="receipt"
		class="space-y-6">
