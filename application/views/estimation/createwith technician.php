			...
			<table class="w-full border-collapse text-sm">
				<tbody>
					...
					<tr>
						...
						<td class="border p-2">
							<input type="text" class="w-full border rounded px-2 py-1"  name="estimatedprice">
						</td>

						<td class="border p-2 font-medium">Estimated Delivery Date</td>
						<td class="border p-2">
							<input type="date" class="w-full border rounded px-2 py-1"  name="estdeldate">
						</td>

						<td class="border p-2 font-medium">Completion Time</td>
						<td class="border p-2">
							<input type="time" class="w-full border rounded px-2 py-1"  name="completiontime">
						</td>
					</tr>
					...
					<tr>
						...
						<td class="border p-2" colspan="5">
							<textarea class="w-full border rounded px-2 py-1 h-20"  name="remarks"></textarea>
						</td>
					</tr>
