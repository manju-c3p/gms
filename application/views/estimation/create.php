...
<script>
	...
	document.getElementById("addService").addEventListener("click", function() {
		...
		// 🔥 Get the last inserted row’s select
		// const newSelect = tbody.lastElementChild.querySelector('.serviceSelect');

		// // Init Select2 ONLY for this select
		// $(newSelect).select2({
		// 	width: '100%',
		// 	templateResult: serviceOptionTemplate,
		// 	templateSelection: serviceOptionTemplate
		// });
	});
	...
	document.addEventListener("input", function(e) {
		...
		// Part table changes
		if (
			e.target.closest("#newPartsTable") ||
			e.target.closest("#aftermarketPartsTable") ||
			e.target.closest("#usedPartsTable")
		) {
	...
	document.addEventListener("click", function(e) {
		if (e.target.classList.contains("remove-row")) {
			...
			// if (table.id === "serviceTable") calculateServiceTotals();
