...
<div class="bg-white shadow-md rounded-xl p-6">
	...
	<form class="grid md:grid-cols-12 gap-4 items-end"
		...
		<div class="md:col-span-2">
			...
			<div class="relative">
				<input type="text"
					   class="w-full border rounded-lg px-3 py-2 datepicker1 focus:ring-2 focus:ring-blue-500"
					   name="from"
					   id="from"
					   value="<?php echo isset($from) ? $from : date('d-M-Y'); ?>"
					   required>
		...
		<div class="md:col-span-2">
			...
			<div class="relative">
				<input type="text"
					   ...
					   name="to"
					   id="to"
					   value="<?php echo isset($to) ? $to : date('d-M-Y'); ?>"
					   required>
