...
<?php foreach ($records1 as $row) { ?>
	...
	<div class="form-group row">
		...
		<label class="col-xs-12 col-sm-1 col-md-2 col-lg-2 col-form-label">PO Code <span style="color: red;"> *
			</span></label>
		<div class="col-xs-12 col-sm-9 col-md-3 col-lg-3">
			<input type="text" name="po_code" id="po_code" class="form-control form-control-sm" tabindex='4'
				value="<?php echo $Code; ?>" required>
		</div>
	</div>
	<div class="form-group row">
		<label class="col-xs-12 col-sm-1 col-md-2 col-lg-2 col-form-label">Supplier Quotation Code</label>
		<div class="col-xs-12 col-sm-9 col-md-4 col-lg-4">
			<input type="text" name="quot_supplier" id="quot_supplier" class="form-control form-control-sm" tabindex='4'
				readonly value="<?php echo $row->quote_code; ?>">
		</div>
		<label class="col-xs-12 col-sm-1 col-md-2 col-lg-2 col-form-label">Supplier Ref No</label>
		<div class="col-xs-12 col-sm-9 col-md-3 col-lg-3">
			<input type="text" name="ref_no" id="ref_no" class="form-control form-control-sm" tabindex='4' value="<?php echo $row->ref_no; ?>">
		</div>
	</div>
	<div class="form-group row">
					...
					<tr id="addr<?php echo $i; ?>">
						...
						<td>
							<select tabindex="11" class="form-select form-control-sm select2 select2Width"
								...
								onchange="get_product_info_old(<?php echo $i; ?>)" required>
						...
						<td>
							...
							<br>
							Total
							<input type="number" step='0.01' name="total[]" id="total<?php echo $i; ?>" value="<?php echo $r->total; ?>"
	...
	<div class="form-group row">
		...
		<div class="col-xs-12 col-sm-9 col-md-2 col-lg-2">
			<input type="number" step='0.01' name="discount" id="discount" class="form-control form-control-sm"
				onkeyup="calculate_grand_total()" value="<?php echo $row->discount_percent; ?>">
		</div>
		<div class="col-xs-12 col-sm-9 col-md-2 col-lg-2">
			<input step='0.01' type="number" name="discount_amt" id="discount_amt" class="form-control form-control-sm"
				onkeyup="calculate_grand_total()" value=<?php echo $row->discount; ?>">
	</div>
	<label class="col-xs-12 col-sm-2 col-md-2  col-lg-2 col-form-label">Total before VAT</label>
		<div class="col-xs-12 col-sm-9 col-md-2 col-lg-2">
			<input type="text" id='total_before_vat' name='total_before_vat' readonly
				class="form-control form-control-sm bg-soft-gray" value="<?php echo $row->sub_total - $row->discount; ?>">
		</div>
	</div>
	<hr class='bg-primary'>
	</hr>
	...
	<div class="form-group row">
		...
		<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
			<input type="text" id='grand_total' name='grand_total' class="form-control form-control-sm"
				value="<?php echo $row->grand_total; ?>" required>
		</div>
	</div>
	<hr>
	...
	<div class="form-group row">
		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
			<textarea style='font-size:12px' cols='50' rows='3' name="term1" id="term1" tabindex=3
				class="form-control form-control-sm"><?php echo $row->payment_terms; ?></textarea>
		</div>
		<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 col-form-label">Delivery Terms:</label>
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
			<textarea style='font-size:12px' cols='50' rows='3' name="term2" id="term2" tabindex=4
				class="form-control form-control-sm"><?php echo $row->delivery_terms; ?></textarea>
		</div>
	</div>
	<div class="form-group row">
		<label class="col-xs-12 col-sm-3 col-md-2 col-lg-2 col-form-label">Notes/Shipping Terms:</label>
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
			<textarea style='font-size:12px' cols='50' rows='3' name="terms" id="terms" tabindex=20
