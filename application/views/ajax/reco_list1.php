...
<div class="overflow-x-auto bg-white rounded-xl shadow-sm border border-gray-200">
	...
	<table id="dr_table" class="min-w-full divide-y divide-gray-200">
		...
		<tbody class="divide-y divide-gray-100">
			<tr>
				<td colspan="7">
					<input type="text" name="selected_tr" id="selected_tr">
				</td>
			</tr>
			...
			<?php foreach ($records as $r) { ?>
				<tr class="hover:bg-gray-50 transition">
					...
					<td class="px-4 py-2" name="inv_id[]"><?php echo $r->voucher_date ?></td>
					<td class="px-4 py-2 font-medium text-gray-700" name="inv_id[]"><?php echo $r->account_name ?></td>
					<td class="px-4 py-2" name="instrument_dates[]"> <?php echo $r->voucher_date ?>
						<input type="text"
							name="voucher_date"
							value="<?php echo $r->voucher_date; ?>">
					</td>
					<td class="px-4 py-2" name="instrument_nos[]"><?php echo $r->transaction_no ?>
						<input type="text"
							name="transaction_no"
							value="<?php echo $r->transaction_no; ?>">
					</td>
					<td class="px-4 py-2 font-semibold" name="deposit_amounts[]"><?php echo $r->amount ?>
						<input type="text"
							name="amount"
