<div class="card-body">
    <div class="dt-responsive table-responsive">
        <form id="main" method="post" action="<?php echo base_url() . 'index.php/'; ?>Hr/view_emp_monthly_salary"
            class="form-horizontal" autocomplete="off" name="question" id="question" enctype="multipart/form-data">

            <div class="form-group row">
                <label class="col-xs-12 col-sm-2 col-md-2 col-lg-2 col-form-label">Month Date: </label>
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="input-group date datepicker1">
                        <input type="text" class="form-control form-control-sm datepicker1" id="from" name="from"
                            value="<?php echo $from; ?>">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="<?php echo base_url() . 'index.php/Hr/print_monthly_payslip/' . $row->sid; ?>"
                        title="Edit" target="_blank">Print Payslip</a>&nbsp;&nbsp;&nbsp;
