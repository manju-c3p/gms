                ...
                <table class="min-w-full border border-gray-200 rounded-lg text-sm" id="tab_logic">
                    ...
                    <thead class="bg-gray-100 text-gray-700">
                        ...
                        <tr>
                            ...
                            <th class="border px-3 py-2 text-left w-[20%]">Used Leave Days</th>
                        ...
                        foreach ($trans as $s): ?>
                            ...
                            <tr id="addr<?php echo $count - 1; ?>">
                                ...
                                <td class="border px-3 py-2">
                                    ...
                                    <input type="number"
                                        name="use_leave_days[]"
                                        id="use_leave_days<?php echo $count - 1; ?>"
                                        class="w-full border border-gray-300 rounded-md px-2 py-1 text-sm bg-gray-100 focus:outline-none"
                                        value="<?php echo $s->use_paid_leave; ?>"
                                        readonly>
