...
<form method="post"
	...
	<div class="bg-white rounded-xl p-4 shadow-sm mb-4">
		...
		<div class="grid grid-cols-5 gap-3">
			...
			<div>
				...
				<select class="w-full h-9 text-sm border border-gray-300 rounded px-2" name="po_id" id="po_id" readonly>
			...
			<div>
				...
				<input type="date" class="w-full h-9 text-sm border border-gray-300 rounded px-2"
					value="<?php echo isset($grn->grn_date) ? date('Y-m-d', strtotime($grn->grn_date)) : ''; ?>" readonly>
			</div>
			...
			<div>
				...
				<input type="hidden" name="supplier_id" value="<?php echo $grn->supplier_id ?? ''; ?>" readonly>
			</div>

			<div>
				<label class="text-sm font-medium text-gray-600 mb-1 block">Reference</label>
				<input type="text" class="w-full h-9 text-sm border border-gray-300 rounded px-2" name="ref_no" readonly>
			</div>
	...
	<div class="bg-white rounded-xl p-4 shadow-sm mb-4">
		...
		<table id="datatable-responsive" class="w-full border border-gray-200 rounded-lg overflow-hidden text-sm" readonly>
					...
					<tr class="border-t hover:bg-gray-50">
						...
						<td class="px-3 py-2">
							...
							<input type="text" name="rec_quantity[]"
								...
								value="<?php echo $row->rec_quantity; ?>" readonly>
						</td>
		...
		<div class="grid grid-cols-12 gap-3">
			...
			<div class="col-span-2">
				...
				<input type="text" name="discount_per" id="discount_per"
					...
					value="<?php echo $grn->discount_percent ?? ''; ?>" readonly>
			</div>
			...
			<div class="col-span-2">
				...
				<input type="text" name="discount_amt" id="discount_amt"
					class="w-full h-9 text-sm border border-gray-300 rounded px-2 text-right"
					value="<?php echo $grn->discount ?? ''; ?>" readonly>
			</div>
			...
			<div class="col-span-2">
				...
				<input type="text" name="vat_per" id="vat_per"
					class="w-full h-9 text-sm border border-gray-300 rounded px-2 text-right"
					value="<?php echo $grn->vat_percent ?? ''; ?>" readonly>
			</div>
			...
			<div class="col-span-2">
				...
				<input type="text" name="vat_amount" id="vat_amount"
					class="w-full h-9 text-sm border border-gray-300 rounded px-2 text-right"
					value="<?php echo $grn->vat_amt ?? ''; ?>" readonly>
			</div>
			...
			<div class="col-span-2">
				...
				<input type="text" name="grand_total" id="grand_total"
					...
					value="<?php echo $grn->grand_total ?? ''; ?>" readonly>
			</div>
	...
	<div class="bg-white rounded-xl p-4 shadow-sm mb-4">
		...
		<div class="grid grid-cols-12 gap-3">
			...
			<div class="col-span-6">
				...
				<textarea class="w-full border border-gray-300 rounded px-2 py-2 text-sm" name="remarks" readonly><?php echo $grn->remark ?? ''; ?></textarea>
			</div>
					...
					<tbody id="inv_dr_body" class="divide-y divide-gray-200">
						...
						<tr id="inv_dr_addr0" class="hover:bg-gray-50">
							<td class="border border-gray-300 px-3 py-2">
								<select class="w-full border border-gray-300 rounded px-2 py-1 text-sm select2 select2Width" id="inv_debtor0" name="inv_debtor[]" required readonly>
							...
							<td><input type="number" step='0.01' name="inv_dr_amount[]" id="inv_dr_amount0" class="border border-gray-300 px-3 py-2" required min=0 value="<?php echo $grn->sub_total; ?>" readonly>
							</td>
						...
						<tr id="inv_dr_addr1" class="hover:bg-gray-50">
							<td class="border border-gray-300 px-3 py-2">
								<select class="w-full border border-gray-300 rounded px-2 py-1 text-sm select2 select2Width" id="inv_debtor1" name="inv_debtor[]" requird readonly>
									<option value="">Select</option>
							...
							<td><input type="number" step='0.01' name="inv_dr_amount[]" id="inv_dr_amount1" class="form-control form-control-sm debit_sum" requird min=0 value="<?php echo $grn->discount ?? ''; ?>" readonly>
							</td>
							<!--<td><a id='delete_row1' title="Delete" onclick='remove_row_inv_dr(0)' class="btn btn-xs bg-orange remove1"><span class="fa fa-trash"></span></a></td>-->
						</tr>
						<tr id="inv_dr_addr2" class="hover:bg-gray-50">
							<td class="border border-gray-300 px-3 py-2">
								<select class="w-full border border-gray-300 rounded px-2 py-1 text-sm select2 select2Width" id="inv_debtor2" name="inv_debtor[]" requird readonly>
									<option value="">Select</option>
							...
							<td><input type="number" step='0.01' name="inv_dr_amount[]" id="inv_dr_amount2" class="form-control form-control-sm debit_sum" requird min=0 value="<?php echo $grn->vat_amt ?? ''; ?>" readonly>
							</td>
							<!--<td><a id='delete_row1' title="Delete" onclick='remove_row_inv_dr(0)' class="btn btn-xs bg-orange remove1"><span class="fa fa-trash"></span></a></td>-->
						</tr>
					</tbody>
				...
				<table class="min-w-full border border-gray-300 rounded-lg text-sm">
					...
					<tbody id="inv_cr_body" class="divide-y divide-gray-200">
						...
						<tr id="inv_cr_addr0" class="hover:bg-gray-50">
							<td class="border border-gray-300 px-3 py-2">
								<select class="w-full border border-gray-300 rounded px-2 py-1 text-sm select2Width" id="inv_creditor0" name="inv_creditor[]" required readonly>
									<option value="">Select</option>
							...
							<td><input type="number" step='0.01' name="inv_cr_amount[]" id="inv_cr_amount0" class="form-control form-control-sm credit_sum" required min=0 value="<?php echo get_voucher_by_trans_id($grn->grn_id, 'G', 'Cr', $grn->account_id); ?>" readonly>
							</td>
						</tr>
