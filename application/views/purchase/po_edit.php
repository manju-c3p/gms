            ...
            <div class="x_content">
              ...
              <div class="well" style="overflow: auto">
                <div class="col-md-12">
                  ...
                  <div class="col-md-2">
                    <input type="date" class="form-control" data-inputmask="'mask' : '99/99/9999'" name="po_date" id="po_date" value="<?php echo $records1[0]->po_date;; ?>">
                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-7 col-sm-9 col-xs-9">
                    ...
                    <input type="hidden" class="form-control" name="supplier_id" id="supplier_id" value="<?php echo $records1[0]->supplier_id;?>"> 
                  </div>
