              ...
              <div class="well" style="overflow: auto">
                  ...
                  <div class="col-md-3">
                    ...
                    <option value="">Select</option>
                        <?php foreach ($supplier_records as $s) { ?>
                            <option value="<?php echo $s->supplier_id ?>"><?php echo $s->supplier_code."-".$s->supplier_name; ?>
                            </option>
                        <?php } ?>
                    </select>  
                  </div>
                ...
                <label class="control-label col-md-1 col-sm-3 col-xs-3">Upload File</label>
                 ...
                 <div class="row col-md-12 col-sm-12" style="overflow: scroll;">
                    <!-- form color picker -->
                      <div class="x_content">
                      <table id="item_table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                            <tr>
